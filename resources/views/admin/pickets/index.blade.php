                    ...
                    <div class="row mb-3">
                        <div class="col-md-5">
                            <form action="" class="form-inline">
                                ...
                                <input type="text" class="form-control mr-2" placeholder="Cari nama siswa"
                                    name='search'>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <div class='d-inline-flex'>
                                            <a href="{{ route('admin.pickets.edit', ['picket' => $picket->id]) }}"
                                                class='btn btn-warning mr-2'><i class="bi bi-pencil-fill"></i></a>
                                            <form
                                                action="{{ route('admin.pickets.destroy', ['picket' => $picket->id]) }}"
                                                method="post">
                                                @csrf
                                                @method('delete')
